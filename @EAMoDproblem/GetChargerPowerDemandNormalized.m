...
% charger_power_demand is a matrix with dimensions obj.NumChargers,obj.Thor
...
charger_power_demand = reshape(charger_power_demand_vec,obj.NumChargers,obj.Thor);
end