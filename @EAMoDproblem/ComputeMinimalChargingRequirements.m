...
% Sum across M
E_start_full_vehicle_pre_1 = sum(obj.spec.FullVehicleInitialPos,1);
% Sum across N
...
% Sum across N
E_start_empty_vehicle_pre = sum(obj.spec.EmptyVehicleInitialPos,1);
...
min_end_charge_true = obj.spec.MinEndCharge + 1;

E_end_min = min_end_charge_true*obj.spec.n_vehicle;

G_charge = digraph(obj.spec.ChargeToTraverse);

ChargeToTraverse_shortest_path = zeros(obj.spec.N,obj.spec.N);
...
E_charge_min_j = E_charge_min*obj.spec.charge_unit_j;

P_charge_min_flat_w = E_charge_min_j/(obj.spec.Thor*obj.spec.time_step_s*obj.spec.NumChargers);
end
