...
if obj.sourcerelaxflag
    f_cost_relax(obj.FindSourceRelaxks(1,1):obj.FindSourceRelaxks(obj.spec.n_passenger_flow,length(obj.spec.passenger_source_list_cell{obj.spec.n_passenger_flow}))) = obj.SourceRelaxCost;
end
