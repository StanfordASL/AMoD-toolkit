...
% carrying vehicles exceeds the link's capacity. In these cases, the code sets the link's residual
% capacity to zero so that rebalancing vehicles avoid these links which are already congested.
